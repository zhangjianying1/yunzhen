...
class Area extends React.Component
{
    ...
    render(){
        return(
            <div className={this.props.className} id={this.props.id} >{this.props.val ? this.props.val : '请选择'}</div>
...
window.lArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '<div class="larea_cancel small-btn btn-purple-bor">取消</div>' +
                    '<div class="larea_finish small-btn btn-purple-bg">确定</div>' +
                    '</div>' +
        ...
        finish: function(e) {
            ...
            _self.params.setValue(provinceText + " " + cityText + " " + countyText);
            _self.close(e);
        },
        close: function(e) {
            e.preventDefault();
            var _self = this;
            var evt = new CustomEvent('div');
